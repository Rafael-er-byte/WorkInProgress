...
export default class Category extends Entity {
  ...
  public updateName(name: CategoryName, modifier: Member): void {
    this.name = name;
    this.addEvent(
      new CategoryNameChanged(DateTime.now(), modifier, this.idProject, this.idCategory, name),
    );
  }
  ...
  public updateColor(color: CategoryColor, modifier: Member): void {
    this.color = color;
    this.addEvent(
      new CategoryColorChanged(DateTime.now(), modifier, this.idProject, this.idCategory, color),
    );
  }
