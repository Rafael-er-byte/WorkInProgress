...
export default class MemberRole extends ValueObject{
    ...
    public canManageTasks(): boolean{
        return this.canManageProject() || this.role === AllowedMemberRoles.manager || this.role === AllowedMemberRoles.contributor; 
    }

    public canUpdateTasks(): boolean{
        return this.canManageProject() || this.canManageTasks() || this.role === AllowedMemberRoles.colaborator; 
    }
};
